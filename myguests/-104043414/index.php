...
<button type="submit" name="addguest" class="btn btn-primary">Add Guest</button>
...
<tr>
  ...
  <td><form action="deleteguest.php" method="POST">
    <input type="hidden" name="id" value="<?=$row['id']?>">
    <button type="submit" name="editguest" class="btn btn-xs btn-success">x</button>
  </form></td>
</tr>
